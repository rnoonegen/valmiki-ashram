      ...
      return (
        <div>
          <p className="text-base leading-8 text-prose-muted">
            ...
            minutes and takes place in a combinations of outdoors and
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6 text-prose-muted">
            ...
            <li>Ayurvedha and life style</li>
      ...
      return (
        <div>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6 text-prose-muted">
            ...
            <li>
              7:30 PM - 8:00 PM: Dinner break, offering a delicious vegetarian
              meal with North and South Indian cuisine.
            </li>
            <li>8:00 PM - 8:30 PM: Prayer and Sayanakaala Mantras.</li>
            <li>
              8:30 PM - 8:45 PM: Evening walk (Bramanam) accompanied by
              discussions on Chanakya Neeti, Bartruhari Neethi, and Slokas.
            </li>
    ...
    if (activeTab === 'dietary') {
      return (
        <div>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6 text-prose-muted">
            <li>8:30 AM - 9:30 AM: Breakfast</li>
            <li>11:00 AM: Snacks</li>
            <li>
              1:00 PM: Nutritious vegetarian lunch featuring both North / South
              Indian dishes.
            </li>
            <li>4:30 PM: Snacks</li>
            <li>
    ...
    return (
      <div>
        ...
        <ul className="mt-4 list-disc space-y-2 pl-6 text-prose-muted">
          ...
          <li>
            6:30 AM: Personal hygiene activities with guidance on how to do to
            maintain a healthy lifestyle, including drinking warm water,
            attending nature&apos;s call, and bathing.
          </li>
