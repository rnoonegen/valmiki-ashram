      ...
      <div className="mx-auto max-w-md rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
        ...
        <form className="mt-6 space-y-4" onSubmit={onSubmit}>
          ...
          <label className="block text-sm text-neutral-800 dark:text-neutral-200">
            ...
            <RequiredStar />
            <input
              className="mt-1 w-full rounded-lg border border-neutral-300 px-3 py-2 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white"
          ...
          <label className="block text-sm text-neutral-800 dark:text-neutral-200">
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full rounded-lg border border-neutral-300 px-3 py-2 pr-11 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white"
