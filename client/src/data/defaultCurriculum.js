export const defaultCurriculum = [
  ...
  {
    title: "IKS (Bharatiya Gyan Parampara)",
    subjects: [
      { title: "Ayurveda & Yoga", children: [] },
      { title: "Natya Shastra", children: [] },
      { title: "Tarka Shastra", children: [] },
      ...
      { title: "Introduction to all Shastras", children: [] },
    ...
    subjects: [
      { title: "Yoga", children: [] },
      {
        ...
        children: [
          ...
          { title: "Dhanurvidya (Archery)" },
        ],
      },
      {
        title: "Bharatiya Khel",
        children: [{ title: "Kabaddi" }, { title: "Seven Stones" }],
      },
      {
        title: "Sports",
        children: [
